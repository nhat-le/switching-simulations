...
load(fullfile(paths.svmmodelpath, 'decoding_common_101421_withknnMdl.mat'))
...
load(fullfile(paths.expdatapath, '102121', 'f02_hmmblockfit_102121c.mat'))
...
files = dir(fullfile(paths.expdatapath, '102121', '*hmmblockfit_102121.mat'));
load(fullfile(paths.expdatapath, '102321', 'allanimals_hmmblockfitsummary_102321.mat'));
...
load(fullfile(paths.expdatapath, 'hmmblockfractions_102421b.mat'));
...
for i = 1:numel(animalnames)
    ...
    load(fullfile(paths.expdatapath, '102121', filename));

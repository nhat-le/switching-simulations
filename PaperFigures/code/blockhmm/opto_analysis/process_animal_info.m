...
% make_plot_states_and_opto(power_flags, area_flags, period_flags, composition,...
...
for animalID = 1:numel(animalinfo)
    ...
    out = get_flags(animalinfo, animalID);
...
% save
savefilename = 'modecounts_033122.mat';
...
% transfunc_opto = nan(NSTATES, 15);
% transfunc_no_opto = nan(NSTATES, 15);
...
switch period_criterion
    ...
    case 'none'
        period_flag = period_flags{1} * 0 + 1;

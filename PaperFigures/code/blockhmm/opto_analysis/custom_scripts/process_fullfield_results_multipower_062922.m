...
global NSTATES
NSTATES = 6;
expfitdate = '062922_fullfield';

% Load the data
load(fullfile('../optodata/', expfitdate, 'opto_hmm_info.mat'));

modetype = '240C';
out_f27 = get_hmm_opto_frac(animalinfo, 1, modetype);
out_f29 = get_hmm_opto_frac(animalinfo, 2, modetype);
out_f32 = get_hmm_opto_frac(animalinfo, 3, modetype);

...
[on2, off2] = plot_mode_fractions(modecounts, xvals_ON + 5, xvals_OFF + 5, [2], period_criterion, msize);

[on3, off3] = plot_mode_fractions(modecounts, xvals_ON + 10, xvals_OFF + 10, [3], period_criterion, msize);

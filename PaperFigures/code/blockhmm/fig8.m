...
load(fullfile(paths.simdatapath, 'blockhmm/blockhmm_simulated_122921.mat'));
...
load(fullfile(paths.simdatapath, 'blockhmm/blockhmm_synthetic_K_validation_122921.mat'));
figure;

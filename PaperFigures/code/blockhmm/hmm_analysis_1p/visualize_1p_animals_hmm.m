rootdir = '/Users/minhnhatle/Dropbox (MIT)/Sur/MatchingSimulations/PaperFigures/code/blockhmm/hmm_analysis_1p';
folders = dir(fullfile(rootdir, 'data_1p/061522defaultK6/*hmmblockfit_061522defaultK6.mat'));
...
% for 070522
statesFlat(8) = 2; %changed from 1->2
...
hmmidentities = flipud([1 1 1 1 3 4; %e57
    1 1 2 4 4 6;%f01
    1 2 5 0 0 0;%f02
    1 1 2 4 4 6;%f03
    1 1 1 3 4 4;%f04
...
namelst = fliplr({'e57', 'f01', 'f02', 'f03', 'f04', 'f25'});

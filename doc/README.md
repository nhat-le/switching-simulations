...
Alternatively, for quickly iterating through all animals, can use the code in the module `src/run_multi_hmm_fits.py`. Remember to change `save` option on line 50 if you want the fitted results to be saved.
